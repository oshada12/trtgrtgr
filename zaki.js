...
//Fake Reply Group
	const reply = (teks) => {
            Zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Zaki.jpg`),"sourceUrl": "https://www.youtube.com/channel/UCzEdH_d_z82l9AI5JDghc0w"}}}, { quoted: m})
        }
        
        const reply1 = (teks) => {
            Zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Subscribe Bot's Official YT Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Zaki.jpg`),"sourceUrl": "https://www.youtube.com/channel/UCzEdH_d_z82l9AI5JDghc0w"}}}, { quoted: m})
        }
try {
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'item2.EMAIL;type=INTERNET:oshadavimukthi76@@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/ᐯ丨爪ㄩҜㄒ卄丨\n'
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;sri lanka;;;;\n'
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
Zaki.sendMessage(m.chat, { contacts: { displayName: '𝙸 𝙰𝚖 ᐯ丨爪ㄩҜㄒ卄丨', contacts: [{ vcard }] } }, { quoted: m })
            }
            break            
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `𝙸 𝙰𝚖 ᐯ丨爪ㄩҜㄒ卄丨 | © 2022`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube',
                                    url: 'https://www.youtube.com/channel/UCzEdH_d_z82l9AI5JDghc0w'
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: txt.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `Note : Jika Ada Masalah Atau Bug Pada Bot Segera Lapor Owner Untuk Dilakukan Perbaikan, Jadilah User Yang Smart.`, hydratedButtons: [{ urlButton: { displayText: 'YouTube', url: 'https://www.youtube.com/channel/UCzEdH_d_z82l9AI5JDghc0w'} }, { callButton: { displayText: 'Owner Number', PhoneNumber: '+6285878313791' } }, { quickReplyButton: { displayText: 'Command', id: '.allmenu', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  Zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
}
break
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: anu.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `Terima Kasih Telah Menggunakan Script Ini, Mohon Jangan Di Perjual Belikan!`, hydratedButtons: [{ urlButton: { displayText: 'YouTube', url: 'https://www.youtube.com/channel/UCzEdH_d_z82l9AI5JDghc0w'} }, { urlButton: { displayText: 'Group', url: 'https://www.youtube.com/channel/UCzEdH_d_z82l9AI5JDghc0w'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donate', id: 'donate', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  Zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
